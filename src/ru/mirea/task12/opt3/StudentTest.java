...
public class StudentTest {
    ...
    public StudentTest(LinkedList<Student> students1, LinkedList<Student> students2) {
    ...
    public static void main(String[] args) {
        ...
        students2.add(new Student(41));
        students2.add(new Student(9));


        new StudentTest(students1, students2);
